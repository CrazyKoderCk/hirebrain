...
<div id="mainimg">
	...
	<center>
	<form name="f" method="post" action="allocate2.jsp">
	<table>
	<tr>
		...
		<%
		String x="";
		String cn3=(String)session.getAttribute("cn");
		Class.forName("com.mysql.jdbc.Driver");
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost/hb","root","");
		Statement st=con.createStatement();	
		ResultSet rs=st.executeQuery("select *from bidproject where cname='"+cn3+"'");
		while(rs.next())
		{
			x=rs.getString(1);
